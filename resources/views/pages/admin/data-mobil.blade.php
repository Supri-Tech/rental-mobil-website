                    ...
                    <form action="{{ route('data-mobil.dashboard') }}" method="GET" class="row g-3">
                        <div class="col-md-4">
                            <input type="text" name="search" class="form-control"
                                placeholder="Cari berdasarkan nama atau merek..." value="{{ request('search') }}">
                        </div>
                        <div class="col-md-4">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    <button class="btn btn-primary btn-sm float-end" data-bs-toggle="modal"
                        data-bs-target="#addCarModal">Tambah Mobil</button>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif($car->status == 'Booked')
                                            <button class="btn btn-secondary btn-sm">{{ $car->status }}</button>
                                        @else
                                            <button class="btn btn-secondary btn-sm">Status Tidak Diketahui</button>
                                        @endif
                                    </td>
                                    <td>
                                        <button class="btn btn-warning btn-sm" onclick="editCar({{ $car }})"
                                        ...
                                        <div class="modal fade" id="deleteModal" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form action="{{ route('cars.destroy', $car->id) }}" id="deleteForm"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                    ...
                                                    <form id="addEditForm"
                                                        ...
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="EditModalLabel">
                                                                {{ isset($car) ? 'Edit Mobil' : 'Tambah Mobil' }}</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                                aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="license_plate" class="form-label">Plat
                                                                        Nomor</label>
                                                                    <input type="text" class="form-control"
                                                                        id="license_plate" name="license_plate"
                                                                        value="{{ isset($car) ? $car->license_plate : '' }}"
                                                                        required>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 mb-3">
                                                                    ...
                                                                    <select class="form-select" name="transmission"
                                                                        id="transmission">
                                                                        <option value="Manual"
                                                                            {{ isset($car) && $car->transmission == 'Manual' ? 'selected' : '' }}>
                                                                            Manual</option>
                                                                        <option value="Automatic"
                                                                            {{ isset($car) && $car->transmission == 'Automatic' ? 'selected' : '' }}>
                                                                            Automatic</option>
                                                                        <option value="Semi-Automatic"
                                                                            {{ isset($car) && $car->transmission == 'Semi-Automatic' ? 'selected' : '' }}>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="fuel_type" class="form-label">Jenis Bahan
                                                                        Bakar</label>
                                                                    <select class="form-select" name="fuel_type"
                                                                        id="fuel_type">
                                                                        <option value="Bensin"
                                                                            {{ isset($car) && $car->fuel_type == 'Bensin' ? 'selected' : '' }}>
                                                                            Bensin</option>
                                                                        <option value="Diesel"
                                                                            {{ isset($car) && $car->fuel_type == 'Diesel' ? 'selected' : '' }}>
                                                                            Diesel</option>
                                                                        <option value="Hybrid"
                                                                            {{ isset($car) && $car->fuel_type == 'Hybrid' ? 'selected' : '' }}>
                                                                            Hybrid</option>
                                                                        <option value="Elektrik"
                                                                            {{ isset($car) && $car->fuel_type == 'Elektrik' ? 'selected' : '' }}>
                                                                            Elektrik</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="passenger_capacity"
                                                                        class="form-label">Kapasitas Penumpang</label>
                                                                    <input type="number" class="form-control"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="base_price_per_day"
                                                                        class="form-label">Harga Sewa Per Hari</label>
                                                                    <input type="text" class="form-control"
                                                                        id="base_price_per_day" name="base_price_per_day"
                                                                ...
                                                                <div class="col-md-6 mb-3">
                                                                    ...
                                                                    <select class="form-select" name="status"
                                                                        ...
                                                                        <option value="Tersedia"
                                                                            {{ isset($car) && $car->status == 'Tersedia' ? 'selected' : '' }}>
                                                                            Tersedia</option>
                                                                        <option value="Diperbaiki"
                                                                            {{ isset($car) && $car->status == 'Diperbaiki' ? 'selected' : '' }}>
                                                                            Diperbaiki</option>
                                                                        <option value="Tidak Aktif"
                                                                            {{ isset($car) && $car->status == 'Tidak Aktif' ? 'selected' : '' }}>
                                                                            Tidak Aktif</option>
                                                                        <option value="Booked"
                                                                            {{ isset($car) && $car->status == 'Booked' ? 'selected' : '' }}>
                                                                            Booked</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12 mb-3">
                                                                    <label for="image_primary" class="form-label">Foto
                                                                        Utama</label>
                                                                    <!-- Tampilkan gambar saat ini jika ada -->
                                                                    @if (isset($car->image_primary) && $car->image_primary)
                                                                        <div class="mb-2">
                                                                            <img id="currentImage"
                                                                                src="{{ asset('storage/' . $car->image_primary) }}"
                                                                                alt="Current Image"
                                                                    ...
                                                                    <input type="file" class="form-control"
                                                                        id="image_primary" name="image_primary"
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit"
                                                                class="btn btn-primary">{{ isset($car) ? 'Update' : 'Simpan' }}</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="base_price_per_day"
