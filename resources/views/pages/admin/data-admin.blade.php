...
@section('title', 'FregaTrans Dashboard - Data Admin')
...
<main>
    <div class="container-fluid px-4">
        ...
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Data Admin dan Superadmin FregaTrans</li>
        </ol>
        
        <!-- Filter dan Search -->
        <div class="card mb-4">
            <div class="card-header">
                <form action="{{ route('data-admin.dashboard') }}" method="GET" class="row g-3">
                    <div class="col-md-6">
        ...
        <div class="card mb-4">
            <div class="card-header">
                ...
                <button class="btn btn-primary btn-sm float-end" data-bs-toggle="modal" data-bs-target="#addUserModal">Tambah Admin</button>
            </div>
            <div class="card-body">
