                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav" id="sidebarMenu">
                            ...
                            <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="collapse"
                                data-bs-target="#transaksiDropdown" aria-expanded="false">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                Transaksi Rental
                            </a>
                            <div class="collapse" id="transaksiDropdown">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{ route('data-booking.dashboard') }}">Pesanan Baru</a>
                                    <a class="nav-link" href="{{ route('data-car-berjalan') }}">Transaksi
                                        Berlangsung</a>
                            ...
                            <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="collapse"
                                data-bs-target="#laporanDropdown" aria-expanded="false">
                            ...
                            <div class="collapse" id="laporanDropdown">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="laporan-penggunaan-mobil.html">Laporan Penggunaan
                                        Mobil</a>
                            ...
                            <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="collapse"
                                data-bs-target="#pengaturanDropdown" aria-expanded="false">
